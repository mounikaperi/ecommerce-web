            ...
            <div className='flex flex-col bg-white rounded-sm shadow'>
              ...
              <div className='flex flex-col gap-2 py-3 text-sm overflow-hidden'>
                <div className='flex flex-col gap-2 border-b px-4'>
                  ...
                  <Slider value={price} onChange={priceHandler} valueLabelDisplay={() => 'Price range slider'} min={0} max={200000} />
                ...
                <div className='flex flex-col border-b px-4'>
                  ...
                  {categoryToggle && (
                    <div className="flex flex-col pb-1">
                      <FormControl>
                        <RadioGroup aria-labelledby="category-radio-buttons-group" onChange={(e) => setCategory(e.target.value)} name="category-radio-buttons" value={category}>
                          {categories.map((el, i) => (
                ...
                <div className='flex flex-col border-b px-4'>
                  ...
                  {ratingsToggle && (
                    <div className="flex flex-col pb-1">
                      <FormControl>
                        <RadioGroup aria-labelledby="ratings-radio-buttons-group" onChange={(e) => setRatings(e.target.value)} value={ratings} name="ratings-radio-buttons">
                          {[4, 3, 2, 1].map((el, i) => (
            ...
            {loading ? <Loader /> : (
              <div className="flex flex-col gap-2 pb-4 justify-center items-center w-full overflow-hidden bg-white">
                ...
                {filteredProductsCount > resultPerPage && (
                  <Pagination count={Number(((filteredProductsCount + 6) / resultPerPage).toFixed())}
                    page={currentPage} onChange={(e, val) => setCurrentPage(val)} color="primary"
                  />
                )}
              </div>
            )}
