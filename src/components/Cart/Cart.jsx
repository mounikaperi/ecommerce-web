          ...
          <div className='flex-1'>
            <div className='flex flex-col shadow bg-white'>
              ...
              <div className='flex justify-end'>
                <button onClick={placeOrderHandler} disabled={cartItems.length < 1} className={`${cartItems.length < 1 ? "bg-primary-grey cursor-not-allowed" : "bg-primary-orange"} w-full sm:w-1/3 mx-2 sm:mx-6 my-4 py-3 font-medium text-white shadow hover:shadow-lg rounded-sm`}>PLACE ORDER</button>
              </div>
            </div>
