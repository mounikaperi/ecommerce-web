...
const MyOrders = () => {
  ...
  useEffect(() => {
    if (loading === false) setFilteredOrders(orders);
  }, [loading, orders]);
            ...
            <div className='flex flex-col bg-white rounded-sm shadow'>
              ...
              <div className='flex flex-col py-3 text-sm'>
                ...
                <div className="flex flex-col gap-3 px-4 mt-1 pb-3 border-b">
                  <FormControl>
                    <RadioGroup aria-labelledby="orderstatus-radio-buttons-group" onChange={(e) => setStatus(e.target.value)} name="orderstatus-radio-buttons" value={status}>
              ...
              <div className='flex flex-col pb-2 text-sm'>
                ...
                <div className='flex flex-col gap-3 mt-1 px-4 pb-3'>
                  <FormControl>
                    <RadioGroup aria-labelledby="ordertime-radio-buttons-group" onChange={(e) => setOrderTime(e.target.value)}
                      name="ordertime-radio-buttons" value={orderTime}>
                        {ordertime.map((el, i) => (
