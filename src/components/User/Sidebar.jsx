      ...
      <div className='flex flex-col bg-white rounded-sm shadow'>
        <div className='flex items-center gap-5 px-4 py-4 border-b'>
          ...
          <Link className='flex w-full justify-between font-medium text-gray-500 hover:text-primary-blue' to='/orders'>
            MY ORDERS <span><ChevronRightIcon /></span>
          </Link>
        </div>
        ...
        <div className="flex items-center gap-5 px-4 py-4 border-b">
          ...
          <Link className="flex w-full justify-between font-medium text-gray-500 hover:text-primary-blue" to="/">MY CHATS<span><ChevronRightIcon /></span></Link>
        </div>
        <div className="flex items-center gap-5 px-4 py-4">
        ...
        <div className="flex items-center gap-5 px-4 py-4 border-b">
          ...
          <div className="flex w-full justify-between font-medium text-gray-500 hover:text-primary-blue cursor-pointer" onClick={handleLogout}>Logout<span><ChevronRightIcon /></span>
          </div>
        </div>
      </div>
