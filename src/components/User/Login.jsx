...
const { useNavigate, useLocation, Link } = require("react-router-dom");
            ...
            <div className='text-center py-10 px-4 sm:px-14'>
              <form onSubmit={handleLogin}>
                <div className='flex flex-col w-full gap-4'>
                  ...
                  <TextField fullWidth id="password" label="Password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required />
