            ...
            <div className='text-center py-10 px-4 sm:px-14'>
              <form onSubmit={handleSubmit}>
                <div className='flex flex-col w-full gap-4'>
                  ...
                  <TextField fullWidth label="Confirm New Password" type="password" name="confirmPassword" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required />
