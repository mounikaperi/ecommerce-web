...
const UpdateProfile = () => {
  ...
  useEffect(() => {
    ...
    if (isUpdated) {
      ...
      dispatch(loadUser());
      navigate("/account");
      dispatch({ type: UPDATE_PROFILE.UPDATE_PROFILE_RESET });
    }
              ...
              <div className='flex flex-col gap-4 items-start'>
                ...
                <div className='flex flex-col w-full justify-between sm:flex-row gap-3 items-center'>
                  ...
                  <label className='rounded font-medium bg-gray-400 text-center cursor-pointer text-white w-full py-2 px-2.5 shadow hover:shadow-lg'>
                    <input type='file' name='avatar' accept='image/*' onChange={handleUpdateDataChange} className='hidden'>Choose File</input>
                  </label>
                </div>
