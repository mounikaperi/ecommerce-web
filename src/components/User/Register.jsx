            ...
            <form onSubmit={handleRegister} encType='multipart/form-data' className='p-5 sm:p-10'>
              <div className='flex flex-col gap-4 items-start'>
                <div className='flex flex-col w-full justify-between sm:flex-col gap-3 items-center'>
                  <TextField fullWidth id="full-name" label="Full Name" name="name" value={name} onChange={handleDataChange} required />
                  <TextField fullWidth id="email" label="Email" type="email" name="email" value={email} onChange={handleDataChange} required />
                </div>
                ...
                <div className='flex flex-col w-full justify-between sm:flex-row gap-3 items-center'>
                  <TextField id="password" label="Password" type="password" name="password" value={password} onChange={handleDataChange} required />
                  <TextField id="confirm-password" label="Confirm Password" type="password" name="cpassword" value={cpassword} onChange={handleDataChange} required />
                </div>
                <div className='flex flex-col w-full justify-between sm:flex-row gap-3 items-center'>
                  ...
                  <label className='rounded font-medium bg-gray-400 text-center cursor-pointer text-white w-full py-2 px-2.5 shadow hover:shadow=lg'>
                    <input type="file" name="avatar" accept="image/*" onChange={handleDataChange} className='hidden' />Choose File
                  </label>
                </div>
