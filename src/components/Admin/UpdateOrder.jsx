              ...
              <div className='flex flex-col sm:flex-row bg-white shadow-lg rounded-lg min-w-full'>
                ...
                <form onSubmit={updateOrderSubmitHandler} className='flex flex-col gap-3 p-8'>
                  ...
                  <FormControl fullWidth sx={{ marginTop: 1 }}>
                    ...
                    <Select labelId="order-status-select-label" id="order-status-select" value={status} label="Status"
                ...
                return (
                  <div className="flex flex-col sm:flex-row min-w-full shadow-lg rounded-lg bg-white px-2 py-5" key={_id}>
                    ...
                    <div className="flex flex-col w-full sm:w-1/2">
                      ...
                      <TrackStepper orderOn={order.createdAt} shippedAt={order.shippedAt}
                        deliveredAt={order.deliveredAt} activeStep={order.orderStatus === "Delivered" ? 2 : order.orderStatus === "Shipped" ? 1 : 0}
                      />
                      </div>
                    </div>
                );
