...
import { UPDATE_USER, REMOVE_USER } from '../../constants/userConstants';
...
const UpdateUser = () => {
  ...
  useEffect(() => {
    ...
    if (isUpdated) {
        ...
        dispatch({ type: UPDATE_USER.UPDATE_USER_RESET });
        dispatch({ type: REMOVE_USER.REMOVE_USER_DETAILS });
            ...
            <form onSubmit={updateUserSubmitHandler} className='p-5 sm:p-10'>
              <div className='flex flex-col gap-3 items-start'>
                <div className='flex flex-col w-full justify-between sm:flex-col gap-3 items-center'>
                  <TextField fullWidth label="Full Name" name="name" value={name} onChange={(e) => setName(e.target.value)} required />
                ...
                <div className='flex flex-col w-full justify-between sm:flex-row gap-3 items-center'>
                  ...
                  <TextField label='Role' select fullWidth variant='outlined' required value={role} onChange={(e) => setRole(e.target.value)}>
